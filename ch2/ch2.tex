...
\begin{figure}[!htb]
 \centering
 %[trim={left bottom right top},clip]
\includegraphics[trim=0 1cm 0 0,clip,height=0.41\linewidth]{ch2/figs/l200_strings.pdf}
\qquad
  \includegraphics[height=0.41\linewidth]{ch2/figs/l200_fig.pdf}
 \caption{\label{fig:L200} Left: {\Ltwo} Ge detectors strings
 surrounded by wavelength-shifting fibers for LAr veto. Right: The L-200 design. The detector array is mounted in the center of the LAr cryostat. Muon veto is achieved by placing the cryostat in a water tank and detecting Cherenkov radiation with photo-multipliers. Source: LEGEND Collaboration.
}
\end{figure}
