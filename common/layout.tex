% Use proper margins.
\geometry{letterpaper,inner=1.25in,top=1in,outer=1in,bottom=1in,nohead}
% double-space text
\doublespacing
...
% Omit page numbers
\titleformat{\chapter}[hang]{\normalfont\fillast\bfseries}{\MakeUppercase{\chaptertitlename} \thechapter: }{0em}{\MakeUppercase}[]
